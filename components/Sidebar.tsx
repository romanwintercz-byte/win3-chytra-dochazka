...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  currentUser, employees, onSwitchUser, onShowAbout
}) => {
  return (
      ...
      <div className="p-4 border-t border-slate-700 space-y-4">
        ...
        <div className="bg-slate-800 p-3 rounded-lg">
          ...
          <select 
            ...
            className="w-full text-xs bg-slate-900 border border-slate-600 text-slate-300 rounded px-2 py-1 focus:outline-none focus:border-indigo-500"
          >
            {employees.map(emp => (
